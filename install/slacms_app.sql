...
(1, 'SLA CMS Starter', '', '', '', '&copy; %YEAR SLA CMS Starter', '', 'CMS, Contact Management System, HTML, CSS, JS, JavaScript, framework, bootstrap, web development, thai, english', 'sladefault', 'english', '', '', 0, '', '', 0, '', '', '', '', '', '', 0, 0, '', '', '', '', '', 0, '', 0, 0, '2016-05-19 15:08:31');
