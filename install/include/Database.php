...
class Database{
    ...
    public function __construct($dbhost = '', $dbuser = '', $dbpass = '', $dbname = ''){
        $this->_connection = new mysqli($dbhost, $dbuser, '', $dbname);
        // $this->_connection = new mysqli($dbhost, $dbuser, '', $dbname);
...
class Version{
    ...
    function __construct() {
        define('BASEPATH', 'slacms');
    }
    
    private function getVersionConfig(){
        $config = array();
        require '../slacms/config/systemconfig.php';
        return $config['sla_version'];
    }
    
    private function getReleaseConfig(){
        $config = array();
        require '../slacms/config/systemconfig.php';
        return $config['sla_release'];
    }
