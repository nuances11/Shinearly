...
if (!empty($_POST) && $_POST['submitbtn'] && $_POST['baseurl'] && $_POST['dbhost'] && $_POST['dbuser'] && $_POST['dbpass'] && $_POST['dbname']) {
    ...
    if ($email && $_POST['password']) {
        ...
        /* Database Insert */
        $filename = 'slacms_app_default.sql';
        $db->mysqli_multi_query_file($mysqli, $filename);
    }
    ...
    if (!$numrow) {
        ...
        $success = 1;
        $db->closeDB();
        if (isset($_COOKIE['csrf_cookie_sla'])) {
            unset($_COOKIE['csrf_cookie_sla']);
            setcookie('csrf_cookie_sla', null, -1, '/');
        }
    }
}
?>
...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Backend System for SLA Content Management" />
        ...
        <div class="container">
            ...
            <?php } else { ?>
                <div class="row">
                    <div class="col-md-12">
                        <br><br>
                        <div class="text-center"><a href="https://www.slacms.com" target="_blank" title="SLA CMS Official Website"><img alt="Site Logo" class="site-logo" src="assets/images/logo.png"></a></div>
                        <br><br>
                        <div class="text-center">
                            <div class="well"><h3 class="form-signin-heading">Install SLA CMS</h3></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <b>
                            ...
                            ?>]<br>
                            ci_session Write Permission [<?php
                            if (is_writable('../ci_session/index.html')) {
                                echo '<span class="success">PASS</span>';
                                $sess_per = 1;
                            } else {
                                echo '<span class="error">FAIL</span>';
                            ...
                            if (is_writable('../slacms/cache/index.html')) {
                                echo '<span class="success">PASS</span>';
                                $cache_per = 1;
                            } else {
                                echo '<span class="error">FAIL</span>';
                            ...
                            if (is_writable('../slacms/db_cache/index.html')) {
                                echo '<span class="success">PASS</span>';
                                $dbcache_per = 1;
                            } else {
                                echo '<span class="error">FAIL</span>';
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <input id="dbname" name="dbname" type="text" class="form-control" placeholder="DB Name for SLA-CMS" required>
                                        <br><span class="text-info">
                                            ...
                                            <a href="https://www.slacms.com/contact-us" target="_blank" class="btn btn-info btn-sm" title="Contact us now!"><b>CONTACT NOW</b></a>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <span class="text-info"><em>Please <b>blank</b>. If you want default backend login account<br>Email: <b>demo@slacms.com</b> | Password: <b>123456</b></em></span>
                                    </div>
                                </div>
                            </div>
                        </div> 
            ...
            <footer>
                ...
                <div class="row">
                    <div class="col-md-8 div-copyright">
                        ...
                        <span class="copyright">Copyright &copy; <?php echo date('Y'); ?> SLA CMS Installer</span>
                        <small style="color:gray;"><br><span class="copyright">Installer for SLA CMS Version <?php echo $version->getVersion(); ?></span></small>
                    </div>
                </div>
            </footer>            
        </div>
