...
class Teacher extends CI_Controller {
    ...
    public function index() {
        ...
        $num_link = 10;
        $base_url = $this->Sla_model->base_link(). '/admin/teacher/';
        // Pageination config
        ...
        //Load the view
        $this->template->loadSub('admin/teacher_index');
    }
    ...
    public function addUser() {
        ...
        //Load the view
        $this->template->loadSub('admin/teacher_add');
    }
    ...
    public function confirm() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            //Validation passed
            //Add the user
            $this->Sla_admin_model->createTeacher(TRUE);
    ...
    public function editUser() {
        ...
        if($this->uri->segment(4)){
            ...
            $users = $this->Sla_admin_model->getUser($this->uri->segment(4), 'teacher');
            if($users !== FALSE){
                $this->template->setSub('users', $users);
                $this->template->setSub('group', $this->Sla_auth_model->get_group_all());
                //Load the view
                $this->template->loadSub('admin/teacher_edit');
            }else{
                redirect($this->sla_referrer->getIndex(), 'refresh');
            }
        }else{
    ...
    public function viewUsers() {
        ...
        if($this->uri->segment(4)){             
            ...
            if($users !== FALSE){
                $this->template->setSub('users', $users);
                //Load the view
                $this->template->loadSub('admin/teacher_view');
            }else{
                redirect($this->sla_referrer->getIndex(), 'refresh');
            }
        }else{
