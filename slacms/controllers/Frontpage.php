...
class Frontpage extends CI_Controller {
    ...
    public function _init() {
        ...
        $this->page_rs = $this->Sla_model->load_page($pageURL);
        ...
        if ($page_rs !== FALSE) {
            $this->template->set('core_css', $this->Sla_model->coreCss($page_rs->custom_css, FALSE));
            $this->template->set('core_js', $this->Sla_model->coreJs($page_rs->custom_js, FALSE));
            $title = $page_rs->page_title . ' | ' . $row->site_name;
            $this->template->set('title', $title);
            $this->template->set('meta_tags', $this->Sla_model->coreMetatags($page_rs->page_desc,$page_rs->page_keywords,$title));
            ...
            $this->template->set('title', $title);
            $this->template->set('meta_tags', $this->Sla_model->coreMetatags('404 Page not Found',$row->keywords,$title));
    ...
    public function index() {
        ...
        if($config->maintenance_active){
            ...
            if($this->page_rs === FALSE){
                ...
                if ($this->Sla_model->findFrmTag($this->page_rs->content) !== false) {
            ...
            //Load the view
            $this->template->loadSub('frontend/home');
        }
    }
    ...
    public function about() {
        ...
        if($config->maintenance_active){
            ...
            //Load the view
            $this->template->loadSub('frontend/about');
        }
    }
    ...
    public function services() {
        ...
        if($config->maintenance_active){
            ...
            //Load the view
            $this->template->loadSub('frontend/services');
        }
    }
    ...
    public function blog() {
        ...
        if($config->maintenance_active){
            ...
            //Load the view
            $this->template->loadSub('frontend/blog');
        }
    }
    ...
    public function contact() {
        ...
        if($config->maintenance_active){
            ...
            //Load the view
            $this->template->loadSub('frontend/contact');
        }
    }
    ...
    public function setLang() {
        $this->Sla_model->setSiteLang($this->uri->segment(2));
