...
<div class="jumbotron">
    <div class="container">
        ...
        <span class="h5"><em><?php echo $this->Sla_model->getLabelLang('article_postdate') ?>: <?php echo $album->timestamp_create ?></em></span>
        <br><br><br>
        <span class="h4"><?php echo $album->short_desc ?></span>
        <br><br><br><p><a class="btn btn-primary btn-lg" href="<?php echo $this->Sla_model->base_link().'/plugin/gallery' ?>" role="button"><?php echo $this->Sla_model->getLabelLang('btn_back') ?></a></p>
    </div>
</div>
<div class="container">
    <div class="row">
        ...
        if($image !== FALSE){
            ...
            $i++; } 
                ...
                <center><h2><?php echo $this->Sla_model->getLabelLang('picture_not_found')?></h2></center>
        <?php } ?>
    </div>
    <br><br>
