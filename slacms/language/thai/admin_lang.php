...
$lang['dashboard_rssnews']	= "ข่าว SLA CMS ล่าสุด 6 รายการ";
...
$lang['ga_no_settings']         = 'Google Analytics ไม่ได้ถูกตั้งค่าบน <a href="'.get_instance()->Sla_model->base_link().'/'.'admin/settings#ga_client_id" title="การตั้งค่าเว็บไซต์"><b>การตั้งค่าเว็บไซต์</b></a>!';
...
//Dashboard
$lang['dash_welcome']		= "ยินดีต้อนรับเข้าสู่เบื้องหลัง SLA CMS";
...
$lang['dash_slacms_link']	= "เว็บไซต์ SLA CMS อย่างเป็นทางการ";

// EMAILS FORGET PASSWORD
$lang['email_reset_subject']    = "รีเซ็ตรหัสผ่านของคุณ SLA-CMS";
...
$lang['sel_option_val_info']            = "ตัวอย่าง, ถ้าคุณต้องการระบุค่าสำหรับตัวเลือก คือ 'value' และโชว์ตัวเลือก คือ 'Show' คุณสามารถระบุได้ดังตัวอย่างนี้ ตัวอย่าง value1=>Show1, value2=>Show2";
...
$lang['upgrade_newlast_alert']          = "SLA-CMS มีเวอร์ชั่นอัพเกรดมาใหม่. กรุณาอัพเกรดเดี๋ยวนี้!";
$lang['upgrade_lastver_alert']          = "SLA-CMS ของคุณคือเวอร์ชั่นล่าสุดแล้ว!";
