...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i><span class="glyphicon glyphicon-user"></span></i> Student Users
            </li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header">Edit Student  <a role="button" href="<?php echo  $this->Sla_model->base_link() ?>/admin/student/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> New Student</a></div>
        <?php echo form_open_multipart($this->Sla_model->base_link().'/admin/student/edited/'.$this->uri->segment(4)); ?>
