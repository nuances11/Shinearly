...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('navpage_new_header') ?>  <a role="button" href="<?php echo  $this->Sla_model->base_link() ?>/admin/navigation/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('navpage_addnew') ?></a></div>
        <?php echo form_open($this->Sla_model->base_link(). '/admin/navigation/update/'.$nav->page_menu_id); ?>
        ...
        <div id="drop_menu"<?php echo ($nav->drop_menu)?' style="display:none;"':''?>>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    if (!empty($plugin)) {
                        foreach ($plugin as $p) {
                            $data[$this->Sla_model->getPluginConfig($p['plugin_config_filename'], 'plugin_urlrewrite')] = $this->Sla_model->getPluginConfig($p['plugin_config_filename'], 'plugin_name');
                        }
                    }
