        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="panel panel-yellow">
                    <div class="panel-heading"><div class="row"><div class="text-left col-xs-6"><b><i class="glyphicon glyphicon-user"></i> <?php echo $users->name; ?></b></div><div class="text-right col-xs-6"><a href="<?php echo $this->sla_referrer->getIndex()?>" style="color:#fff;"><i class="glyphicon glyphicon-arrow-left"></i> <?php echo $this->lang->line('btn_back') ?></a></div></div></div>
