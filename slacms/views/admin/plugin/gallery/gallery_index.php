    ...
    <div class="col-lg-12" style="word-wrap:break-word;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <h5><b><?php echo $this->lang->line('gallery_header') ?>:</b> <?php echo $this->Sla_model->base_link().'/plugin/gallery/getWidget' ?>/{language_iso}</h5>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><div class="row"><div class="text-left col-xs-8"><?php echo  $this->lang->line('gallery_header') ?> <a role="button" href="<?php echo $this->Sla_model->base_link()?>/admin/plugin/gallery/add" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('gallery_new_header') ?></a></div><div class="text-right col-xs-4"><a class="btn btn-default btn-sm" href="<?php echo $this->sla_referrer->getIndex(); ?>"><span class="glyphicon glyphicon-arrow-left"></span> <?php echo $this->lang->line('btn_back'); ?></a></div></div></div>
        ...
        <br><br>
        <?php echo form_open($this->Sla_model->base_link(). '/admin/plugin/gallery/albumIndexSave'); ?>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                ?>
                <a class="btn btn-lg" href="<?php echo $this->sla_referrer->getIndex('gallery'); ?>"><?php echo $this->lang->line('btn_cancel'); ?></a>
            </div>
        </div>
        <?php echo  form_close(); ?>
        <!-- /widget-content --> 
