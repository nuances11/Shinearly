...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <?php echo form_open_multipart($this->Sla_model->base_link(). '/admin/plugin/gallery/editSave/'.$this->uri->segment(5)); ?>
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                ...
                <?php echo  form_open($this->Sla_model->base_link(). '/admin/plugin/gallery/addYoutube/'.$this->uri->segment(5)) ?>
            ...
            <div class="col-lg-6 col-md-6">  
                ...
                <?php echo  form_open_multipart($this->Sla_model->base_link(). '/admin/plugin/gallery/htmlUpload/'.$this->uri->segment(5)) ?>
        ...
        <?php echo  form_open($this->Sla_model->base_link(). '/admin/plugin/gallery/uploadIndexSave'); ?>
