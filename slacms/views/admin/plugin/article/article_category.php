...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><div class="row"><div class="text-left col-xs-8"><?php echo  $this->lang->line('category_header') ?> <a role="button" href="<?php echo $this->Sla_model->base_link()?>/admin/plugin/article/catadd" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('category_new_header') ?></a></div><div class="text-right col-xs-4"><a class="btn btn-default btn-sm" href="<?php echo $this->sla_referrer->getIndex('article'); ?>"><span class="glyphicon glyphicon-arrow-left"></span> <?php echo $this->lang->line('btn_back'); ?></a></div></div></div>
        ...
        <br><br>
        <?php echo  form_open($this->Sla_model->base_link(). '/admin/plugin/article/catIndexSave'); ?>
