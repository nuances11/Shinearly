...
<div class="row">
    <div class="col-lg-6 col-md-6">
        <div class="panel panel-primary">
            ...
            <a href="<?php echo $this->Sla_model->base_link(). '/admin/plugin/article/category' ?>">
    ...
    <div class="col-lg-6 col-md-6">
        <div class="panel panel-green">
            ...
            <a href="<?php echo $this->Sla_model->base_link(). '/admin/plugin/article/article' ?>">
                <div class="panel-footer">
                    <span class="pull-left"><?php echo $this->lang->line('dashboard_viewdetail') ?></span>
                    <span class="pull-right"><i><span class="glyphicon glyphicon-expand"></span></i></span>
                    <div class="clearfix"></div>
    ...
    <div class="col-lg-12" style="word-wrap:break-word;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <h5><b><?php echo $this->lang->line('article_header') ?>:</b> <?php echo $this->Sla_model->base_link().'/plugin/article/getWidget' ?>/{language_iso}/{category_id}</h5>
