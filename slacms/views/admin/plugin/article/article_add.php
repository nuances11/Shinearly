...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo $this->lang->line('article_new_header').' <a class="btn btn-default btn-sm" href="'.$this->sla_referrer->getIndex('article_art').'"><span class="glyphicon glyphicon-arrow-left"></span> '.$this->lang->line('btn_back').'</a>'; ?></div>
        <?php echo form_open_multipart($this->Sla_model->base_link().'/admin/plugin/article/addsave'); ?>     
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('title', $this->Sla_admin_model->getDraftArray('title'), FALSE)
            );
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('keyword', $this->Sla_admin_model->getDraftArray('keyword'), FALSE)
            );
            echo form_input($data);
            ?>			
        </div> <!-- /control-group -->
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('short_desc', $this->Sla_admin_model->getDraftArray('short_desc'), FALSE)
            );
            echo form_input($data);
            ?>
        </div> <!-- /control-group -->
        <div class="control-group">
            ...
            echo form_dropdown('cat_id', $data, $this->Sla_admin_model->getDraftArray('cat_id'), $att);
            ?>
            </div> <!-- /controls -->
        </div> <!-- /control-group -->
        <div class="control-group">
        ...
        <div class="form-actions">
            ...
            ?> 
            <a class="btn btn-lg" href="<?php echo $this->sla_referrer->getIndex('article_art'); ?>"><?php echo $this->lang->line('btn_cancel'); ?></a>
        </div> <!-- /form-actions -->
<?php echo form_close(); ?>
        <!-- /widget-content --> 
    </div>
