...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('forms_edit') ?>  <a role="button" href="<?php echo  $this->Sla_model->base_link() ?>/admin/forms/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('forms_addnew') ?></a></div>
        <?php echo form_open_multipart($this->Sla_model->base_link(). '/admin/forms/edited/'.$this->uri->segment(4)); ?>
                ...
                <div class="panel-body row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="control-group text-right">
                            <a class="btn btn-danger" role="button" onclick="return confirm('<?php echo $this->lang->line('forms_delete_msg')?>')" href="<?php echo $this->Sla_model->base_link().'/admin/forms/deleteField/'.$form_rs->form_main_id.'/'.$field_val['form_field_id']?>">
