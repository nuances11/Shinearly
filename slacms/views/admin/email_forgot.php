        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body text-center">
                    <?php if(!$chksts){ ?>
                        <?php echo  form_open($this->Sla_model->base_link(). '/admin/user/forgot') ?>
                        ...
                        <br>
                        <button class="btn btn-lg btn-primary" type="submit" id="forget_submit"><?php echo $this->lang->line('forgot_btn'); ?></button> &nbsp;&nbsp; <a class="btn btn-lg" name="newsletter_cancel" id="contact_database_cancel" href="<?php echo $this->Sla_model->base_link(). '/admin'?>"><?php echo $this->lang->line('btn_cancel'); ?></a>
                        <?php echo  form_close() ?>
                    <?php }if($chksts){ ?>
                        <p class="success"><?php echo $this->lang->line('forgot_check_email'); ?></p>
                        <br>
                        <a class="btn btn-lg btn-primary" name="reset_back" id="reset_back" href="<?php echo $this->Sla_model->base_link(). '/admin'?>"><?php echo $this->lang->line('btn_back'); ?></a>
                    <?php } ?>
                </div>
            </div>
        </div>
