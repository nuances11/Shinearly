...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('genlabel_edit_header') ?> <a href="<?php echo $this->Sla_model->base_link(). '/admin/genlabel/synclang'?>" class="btn btn-primary" onclick="return confirm('<?php echo $this->lang->line('delete_message');?>')"><i class="glyphicon glyphicon-refresh"></i> <?php echo $this->lang->line('btn_label_synclang')?></a></div>
        <?php echo form_open($this->Sla_model->base_link(). '/admin/genlabel/updated/'.$this->uri->segment(4)); ?>
        ...
        <div class="control-group">	
            ...
            <div class="well well-sm"><b><?php echo $this->Sla_model->getValue('lang_en', 'general_label', 'general_label_id', $this->uri->segment(4), 1)->lang_en; ?></b></div>
        </div> <!-- /control-group -->
