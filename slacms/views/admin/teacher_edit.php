...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i><span class="glyphicon glyphicon-user"></span></i> Teacher Users
            </li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header">Edit Teacher  <a role="button" href="<?php echo  $this->Sla_model->base_link() ?>/admin/teacher/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> New Teacher</a></div>
        <?php echo form_open_multipart($this->Sla_model->base_link().'/admin/teacher/edited/'.$this->uri->segment(4)); ?>
        ...
        <div class="control-group">	
            ...
            <?php
                ...
                $user_group = $this->Sla_auth_model->get_groups_fromuser($users->user_admin_id);
