...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('banner_header') ?> <a role="button" href="<?php echo $this->Sla_model->base_link()?>/admin/banner/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('banner_new') ?></a></div>
        <form action="<?php echo $this->Sla_model->base_link(). '/admin/banner/'; ?>" method="get">
        ...
        <br><br>
        <?php echo  form_open($this->Sla_model->base_link(). '/admin/banner/deleteindex'); ?>
                ...
                <tbody>
                    ...
                    <?php } else { ?>
                        ...
                        foreach ($banner as $u) {
                            ...
                            echo '<td class="text-center"'.$inactive.'>' . number_format($this->Sla_model->countData('banner_statistic', $where_arr)) . '</td>';
                            echo '<td class="text-center"'.$inactive.'><a href="'.$this->Sla_model->base_link().'/admin/banner/edit/' . $u['banner_mgt_id'] . '" class="btn btn-default btn-sm" role="button"><i class="glyphicon glyphicon-pencil"></i>  '.$this->lang->line('btn_edit').'</a> &nbsp;&nbsp;&nbsp; <a href="'.$this->Sla_model->base_link().'/admin/banner/view/' . $u['banner_mgt_id'] . '" class="btn btn-primary btn-sm" role="button"><i class="glyphicon glyphicon-stats"></i>  '.$this->lang->line('btn_view').'</a>';
                            echo '</td></tr>';
                        }
                        ?>
                    <?php } ?>
