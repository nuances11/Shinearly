    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">  
                ...
                <?php echo  form_open_multipart($this->Sla_model->base_link(). '/admin/filehtmlupload') ?>
        ...
        <form action="<?php echo $this->Sla_model->base_link(). '/admin/uploadindex/'; ?>" method="get">
        ...
        <br><br>
        <?php echo  form_open($this->Sla_model->base_link(). '/admin/uploadindex_save'); ?>
                    ...
                    <?php } else { ?>
                        <?php foreach ($showfile as $file) { ?>
                            <tr>
                                ...
                                <td class="text-center" style="vertical-align:middle;">
                                    <a href="<?php echo $this->Sla_model->base_link().'/admin/uploadDownload/'.$file["upload_file_id"] ?>" class="btn btn-primary" role="button" title="<?php echo  $this->lang->line('uploadfile_download') ?>" target="_blank"><i class="glyphicon glyphicon-download"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } ?>
