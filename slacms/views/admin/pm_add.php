...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('pm_new_msg') ?> <a role="button" href="<?php echo $this->Sla_model->base_link()?>/admin/pm/newpm" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo $this->lang->line('pm_new_msg') ?></a></div>
        <?php echo form_open($this->Sla_model->base_link(). '/admin/pm/insert'); ?>
