...
<!-- /.row -->
<?php echo form_open_multipart($this->Sla_model->base_link().'/admin/settings/update'); ?>
<div class="row">
    ...
    <div class="col-lg-6 col-md-6">
        ...
        <a href="<?php echo $this->Sla_model->base_link().'/admin/settings/gensitemap' ?>" class="btn btn-success" title="<?php echo $this->lang->line('settings_sitemap_header') ?>"><?php echo $this->lang->line('settings_sitemap_runnow') ?></a><br>
