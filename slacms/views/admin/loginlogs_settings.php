...
<div class="row">
    <div class="col-lg-4 col-md-4">
        ...
        <a href="<?php echo $this->Sla_model->base_link().'/admin/bfsettings/genPrivateKey' ?>" class="btn btn-success" title="<?php echo $this->lang->line('bf_gen_private_key') ?>" onclick="return confirm('<?php echo $this->lang->line('bf_gen_private_key_confirm') ?>');"><?php echo $this->lang->line('bf_gen_private_key') ?></a><br><br>
        ...
        <?php echo form_open($this->Sla_model->base_link(). '/admin/bfsettings/save'); ?>
    ...
    <div class="col-lg-4 col-md-4">
        ...
        <?php echo form_open($this->Sla_model->base_link(). '/admin/bfsettings/whiteipsave'); ?>
                ...
                <tbody>
                    ...
                    <?php } else { ?>
                        ...
                        foreach ($whitelist as $u) {
                            ...
                            echo '<td class="text-center" style="vertical-align:middle;"><a role="button" class="btn btn-danger btn-sm" role="button" onclick="return confirm(\''.$this->lang->line('delete_message').'\')" href="'.$this->Sla_model->base_link().'/admin/bfsettings/whiteipdel/'.$u['whitelist_ip_id'].'"><i class="glyphicon glyphicon-remove"></i></a></td>';
                            echo '</tr>';
                        }
                        ?>
                    <?php } ?>
    ...
    <div class="col-lg-4 col-md-4">
        ...
        <?php echo form_open($this->Sla_model->base_link(). '/admin/bfsettings/blackipsave'); ?>
        <div class="form-group">
            <label><?php echo $this->lang->line('ip_address') ?></label>
            <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-laptop"></i></div>
                ...
                <tbody>
                    ...
                    <?php } else { ?>
                        ...
                        foreach ($blacklist as $u) {
                            echo '<tr>';
                            echo '<td style="vertical-align:middle;">'.$u['ip_address'].'<br><span style="font-style: italic; font-size:12px;">'.$u['note'].'</span></td>';
                            echo '<td class="text-center" style="vertical-align:middle;"><a role="button" class="btn btn-danger btn-sm" role="button" onclick="return confirm(\''.$this->lang->line('delete_message').'\')" href="'.$this->Sla_model->base_link().'/admin/bfsettings/blackipdel/'.$u['blacklist_ip_id'].'"><i class="glyphicon glyphicon-remove"></i></a></td>';
                            echo '</tr>';
                        }
                        ?>
                    <?php } ?>
