<?php $row = $this->Sla_model->load_config(); ?>
<div class="container">
    <div class="row">
        <div class="col-md-3 hidden-sm hidden-xs"></div>
        <div class="col-md-6 col-sm-12 col-xs-12">
            <center><span style="font-size:36px;color:#ff6f00;"><a href="<?php echo $this->Sla_model->base_link() ?>" target="_blank"><?php echo $this->Headfoot_html->getLogo(); ?></a></span></center>
            <br><br>
            <div class="panel panel-primary">
                ...
                <div class="panel-body text-left">
                    ...
                    <?php echo form_open($this->Sla_model->base_link(). '/admin/login/check') ?>
                ...
                <div class="panel-footer text-center"><a href="<?php echo $this->Sla_model->base_link(); ?>/admin/user/forgot"><?php echo $this->lang->line('login_forgetpwd'); ?></a></div>
            </div>
        </div>
        <div class="col-md-3 hidden-sm hidden-xs"></div>
    </div>
