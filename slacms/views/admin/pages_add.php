...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('pages_addnew') ?>  <a role="button" href="<?php echo  $this->Sla_model->base_link() ?>/admin/pages/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('pages_addnew') ?></a></div>
        <?php echo form_open($this->Sla_model->base_link(). '/admin/pages/insert'); ?>
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('page_name', $this->Sla_admin_model->getDraftArray('page_name') , FALSE)
            );
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('page_title', $this->Sla_admin_model->getDraftArray('page_title'), FALSE)
            );
            echo form_input($data);
            ?>				
        </div> <!-- /control-group -->
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('page_keywords', $this->Sla_admin_model->getDraftArray('page_keywords'), FALSE)
            );
            echo form_input($data);
            ?>				
        </div> <!-- /control-group -->
        ...
        <div class="control-group">
            ...
            $data = array(
                ...
                'autofocus' => 'true',
                'class' => 'form-control',
                'value' => set_value('page_desc', $this->Sla_admin_model->getDraftArray('page_desc'), FALSE)
            );
            echo form_input($data);
            ?>			
        </div> <!-- /control-group -->
        ...
        <div class="control-group">	
            ...
            <?php
                ...
                echo form_dropdown('lang_iso', $data, $this->Sla_admin_model->getDraftArray('lang_iso'), $att);
            ?>	
        </div> <!-- /control-group -->
        <br>
        <div class="control-group">										
        ...
        <div class="control-group">            
            ...
            $data = array(
                ...
                'id' => 'custom_css',
                'class' => 'form-control',
                'value' => set_value('custom_css', $this->Sla_admin_model->getDraftArray('custom_css'), FALSE)
            );
        ...
        <div class="control-group">            
            ...
            $data = array(
                ...
                'id' => 'custom_js',
                'class' => 'form-control',
                'value' => set_value('custom_js', $this->Sla_admin_model->getDraftArray('custom_js'), FALSE)
            );
            echo form_textarea($data);
            ?>			
        </div> <!-- /control-group -->
        <div class="control-group">
            ...
            <textarea name="content" id="content" class="form-control body-tinymce"><?php if($this->Sla_admin_model->getDraftArray('content')){ echo $this->Sla_admin_model->getDraftArray('content'); }else{ echo $starter_html; } ?></textarea>
        </div> <!-- /control-group -->
        <br><br>
        <?php
            $data = array(
