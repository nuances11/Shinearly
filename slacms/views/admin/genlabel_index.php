...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo $this->lang->line('genlabel_header') ?> <a href="<?php echo $this->Sla_model->base_link(). '/admin/genlabel/synclang'?>" class="btn btn-primary" onclick="return confirm('<?php echo $this->lang->line('delete_message');?>')"><i class="glyphicon glyphicon-refresh"></i> <?php echo $this->lang->line('btn_label_synclang')?></a></div>
                ...
                <tbody>
                    ...
                    <?php } else { ?>
                        ...
                        foreach ($genlab as $gl) {
                            ...
                            echo '</td>';
                            echo '<td class="text-center"><a href="'.$this->Sla_model->base_link().'/admin/genlabel/edit/' . $gl['general_label_id'] . '" class="btn btn-default btn-sm" role="button"><i class="glyphicon glyphicon-pencil"></i>  '.$this->lang->line('btn_edit').'</a></td>';
                            echo '</tr>';
                        } ?>
                    <?php } ?>
                </tbody>
