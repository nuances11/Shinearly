...
<html lang="<?php echo $row->admin_lang ?>">
    <head> 
        ...
        <!-- Custom CSS -->
        <?php echo link_tag('templates/admin/css/style.css') ?>
        ...
        <?php if($this->session->userdata('user_admin_id') && $this->session->userdata('admin_email') && $this->session->userdata('admin_logged_in')){ ?>
            ...
            <div class="wrapper">
                ...
                <header class="main-header">
                    <!-- Logo -->
                    <a class="logo" href="<?php echo $this->Sla_model->base_link().'/admin'; ?>">
                        <!-- mini logo for sidebar mini 50x50 pixels -->
                        <span class="logo-mini"><b>SLA</b></span>
                    ...
                    <nav class="navbar navbar-static-top">
                        ...
                        <div class="navbar-custom-menu">
                            <ul class="nav navbar-nav">
                                ...
                                <?php $unread = $this->Sla_auth_model->count_unread_pms(); ?>
                                <li class="dropdown messages-menu">
                                  ...
                                  <ul class="dropdown-menu">
                                    ...
                                    <li>
                                      ...
                                      <ul class="menu">
                                        <?php $unread_msg = $this->Sla_auth_model->list_pms(10, 0, $this->session->userdata('user_admin_id'), '', TRUE);
                                        if($unread_msg !== FALSE){
                                        foreach($unread_msg as $value){ ?>
                                            <!-- start message -->
                                            <li>
                                              <a href="<?php echo $this->Sla_model->base_link(); ?>/admin/pm/view/<?php echo $value['id']; ?>">
                                                  <div class="pull-left" style="margin-top:-5px;">
                                                    <i class="fa fa-envelope"></i>
                                                </div>
                                                  <h4 style="margin: 0 0 0 20px;">
                                                  <?php echo $this->Sla_admin_model->getUser($value['sender_id'])->name ?>
                                    ...
                                    <li class="footer"><a href="<?php echo $this->Sla_model->base_link(); ?>/admin/pm"><b><?php echo $this->lang->line('pm_seeall_msg') ?></b></a></li>
                                  </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="user-header">
                                            ...
                                            <p>
                                                ...
                                                <?php $user_group = $this->Sla_auth_model->get_groups_fromuser($users->user_admin_id); ?>
                                        ...
                                        <li class="user-footer">
                                            <div class="pull-left">
                                                <a href="<?php echo $this->Sla_model->base_link(); ?>/admin/users/edit/<?php echo $this->session->userdata('user_admin_id'); ?>" class="btn btn-default btn-flat"><i class="fa fa-edit"></i> <?php echo $this->lang->line('user_edit_header'); ?></a>
                                            </div>
                                            <div class="pull-right">
                                                <a href="<?php echo $this->Sla_model->base_link(); ?>/admin/logout" class="btn btn-default btn-flat"><i class="fa fa-sign-out text-red"></i> <?php echo $this->lang->line('nav_logout'); ?></a>
                                            </div>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo $this->Sla_model->base_link(). '/admin/upgrade/clearAllCache' ?>" onclick="return confirm('<?php echo $this->lang->line('delete_message') ?>');"><?php echo $this->lang->line('btn_clearallcache') ?></a></li>
                                        <li><a href="<?php echo $this->Sla_model->base_link(). '/admin/upgrade/clearAllDBCache' ?>" onclick="return confirm('<?php echo $this->lang->line('delete_message') ?>');"><?php echo $this->lang->line('btn_clearalldbcache') ?></a></li>
                                        <li><a href="<?php echo $this->Sla_model->base_link(). '/admin/upgrade/clearAllSession' ?>" onclick="return confirm('<?php echo $this->lang->line('clear_sess_message') ?>');"><?php echo $this->lang->line('btn_clear_sess') ?></a></li>
                                    </ul>
                                </li>
                    ...
                    <section class="sidebar">
                        ...
                        <div class="user-panel">
                            ...
                            <div class="pull-left info">
                                ...
                                <a href="<?php echo $this->Sla_model->base_link(); ?>/admin/users/edit/<?php echo $this->session->userdata('user_admin_id'); ?>"><i class="fa fa-edit"></i> <b><?php echo $this->lang->line('user_edit_header'); ?></b></a>
                            </div>
                        </div>
                ...
                <div class="content-wrapper">
                    <div class="container-fluid">
                        ...
                        <?php if($this->Sla_admin_model->chkVerUpdate($this->Sla_model->getVersion()) !== FALSE){ ?>
                        <a href="<?php echo $this->Sla_model->base_link()?>/admin/upgrade" title="<?php echo $this->lang->line('btn_upgrade')?>"><div class="alert alert-warning text-center" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><?php echo $this->lang->line('upgrade_newlast_alert')?></div></a>
                        <?php } ?>
