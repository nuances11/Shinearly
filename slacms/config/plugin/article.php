...
$plugin_config['plugin_file_path']   = array(
    ...
    FCPATH . '/slacms/config/plugin/article.php',
    FCPATH . '/slacms/controllers/admin/plugin/Article.php',
    FCPATH . '/slacms/models/plugin/Article_model.php',
    FCPATH . '/slacms/modules/plugin/controllers/Article.php',
    FCPATH . '/slacms/modules/plugin/views/article/',
    FCPATH . '/slacms/views/admin/plugin/article/',
    FCPATH . '/slacms/language/dutch/plugin/article_lang.php',
    FCPATH . '/slacms/language/english/plugin/article_lang.php',
    FCPATH . '/slacms/language/italian/plugin/article_lang.php',
    FCPATH . '/slacms/language/spanish/plugin/article_lang.php',
    FCPATH . '/slacms/language/thai/plugin/article_lang.php',
);
