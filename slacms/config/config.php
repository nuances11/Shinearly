...
$config['sess_cookie_name'] = 'sla_sess';
...
|
*/
$config['cookie_prefix']	= 'slacookie';
...
$config['csrf_token_name'] = 'csrf_sla';
$config['csrf_cookie_name'] = 'csrf_cookie_sla';
...
*/
$config['proxy_ips'] = PROXY_IP_CONFIG;
