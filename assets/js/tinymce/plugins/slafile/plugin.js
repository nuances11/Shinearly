...
tinymce.PluginManager.add('slafile', function(editor) {

    tinymce.activeEditor.settings.file_browser_callback = slaFileBrowser;

    function slaFileBrowser(field_name, url, type, win) {
